...
def save_results(visuals,result_dir):
    ...
    img_real_A = tensor2im(visuals['real_A'])
    img_fake_B = tensor2im(visuals['fake_B'])
    img_rec_A = tensor2im(visuals['rec_A'])
    img_idt_B = tensor2im(visuals['idt_B'])
    ...
    img_real_B = tensor2im(visuals['real_B'])
    img_fake_A = tensor2im(visuals['fake_A'])
    img_rec_B = tensor2im(visuals['rec_B'])
    img_idt_A = tensor2im(visuals['idt_A'])
